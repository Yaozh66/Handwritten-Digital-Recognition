function [psAugParam,optimState] = psAugInit(Iterate,options,optimState)
...
optimState.numNonlinIneqcstr = numNonlinIneqcstr;
optimState.numNonlinEqcstr = numNonlinEqcstr;
optimState.numNonlinCstr = numNonlinCstr;
