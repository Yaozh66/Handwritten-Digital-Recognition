...
[Iterate.x,Aineq,Bineq,Aeq,Beq,msg,how,exitflag]= eqnsolv(Iterate.x,Aineq,Bineq,Aeq,Beq,LB,UB,tol,verbosity);
...
if ~feasible
    ...
    [Iterate.x,~,success] = linprog([],Aineq,Bineq,Aeq,Beq,LB,UB,[], ...
    ...
    if success <=0 || ~feasible
        ...
        [Iterate.x,success] = globaloptim.internal.initialfeasible(Iterate.x,A,L,U);
    end
    if success <= 0
        Iterate.x = Xin;
